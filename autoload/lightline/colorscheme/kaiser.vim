...
if exists('g:lightline')
  ...
  let s:p.normal.middle   = [ [ s:gradient4, s:gradient1 ] ]
  ...
  let s:p.insert.middle   = [ [ s:gradient4, s:gradient1 ] ]
  ...
  let s:p.visual.middle   = [ [ s:gradient4, s:gradient1 ] ]
  ...
  let s:p.replace.middle  = [ [ s:gradient4, s:gradient1 ] ]
  let s:p.inactive.right  = [ [ s:selection, s:gradient1 ], [ s:selection, s:gradient1 ] ]
  let s:p.inactive.left   = [ [ s:selection, s:gradient1 ], [ s:selection, s:gradient1 ] ]
  let s:p.inactive.middle = [ [ s:selection, s:gradient1 ] ]
  ...
  let s:p.terminal.middle = [ [ s:gradient4, s:gradient1 ] ]
